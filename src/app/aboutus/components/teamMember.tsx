  ...
  return (
    <>
      <div className="w-full flex flex-col justify-center items-center h-full cursor-pointer group">
        <div className=" SMALL_LAPTOP:bg-[#DBDBDB] SMALL_LAPTOP:group-hover:bg-themeColor transition-all ease-linear bg-primary border-2 border-[#DBDBDB] rounded-[1rem] relative  flex mb-[1rem] w-full aspect-[3/4] overflow-hidden bg-themeColor  ">
