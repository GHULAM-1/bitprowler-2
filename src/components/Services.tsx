...
import { ServiceCardContent } from "@/data/servicesData/servicesCardContent"
export default function Services(){
  return <>

  
  
      <div className="bg-background grid grid-cols-3 justify-center justify-items-center px-[10rem] max-[1222px]:grid-cols-2 max-[1146px]:px-[1rem] max-[676px]:grid-cols-1 max-[676px]:px-[1rem] ">
     
      {
    ServiceCardContent.map((cardContent , index) => {
      return (
        
        <>

        <ServiceCard mainHeading={cardContent.mainHeading} description={cardContent.description} iconDark={cardContent.iconDarkMode} iconLight={cardContent.iconLightMode}></ServiceCard>
