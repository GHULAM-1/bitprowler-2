...
const pillsVariants = cva("flex flex-row justify-center items-center gap-2", {
  variants: {
    intent: {
      cta: " bg-themeColor  ",
      ...
      Seo: "bg-seoBg dark:border-seoBorder text-seoText border-[1px]",
      Marketing:
    ...
    size: {
      ...
      blogTags:
        "text-Mobile-S-Text TABLET:text-Mobile-Text py-1 px-2   rounded-[1rem]  TABLET:rounded-[2rem] transition-all whitespace-nowrap",
    },
  },
