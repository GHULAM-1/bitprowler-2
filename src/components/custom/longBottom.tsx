...
export default function LongBottom() {
  return (
    <>
      <div className="flex  items-center p-[1rem] justify-between bg-[#EAEAEA] dark:bg-[#151515] text-black dark:text-white w-[98%] rounded-t-[0.5rem] ">
      ...
      <div className="flex justify-center items-center text-[0.8rem]  py-[1rem] dark:bg-[#151515] bg-[#EAEAEA] w-full dark:text-white text-black laptop_sm:hidden">
        © Copyright 2023. All rights reserved.
      </div>
    </>
  );
